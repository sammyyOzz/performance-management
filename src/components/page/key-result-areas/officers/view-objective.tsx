...
export const ViewObjective: FC<ViewObjectiveProps> = ({ isOpen, close }) => {
    return (
                        ...
                        <div className="flex flex-col gap-4 h-full w-full max-w-2xl mx-auto">
                            <div className="flex flex-col gap-4 overflow-y-scroll scrollbar-hide">
                                <div className="flex items-center justify-between gap-2">
                                    <Drawer.Title className="font-semibold text-2xl text-gray-900">Develop training workplan and programs</Drawer.Title>
                                ...
                                <div className="flex flex-col w-full gap-5">
                                    <BaseInput label="Name of this Objective" type="text" />
