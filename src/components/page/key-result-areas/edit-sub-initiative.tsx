...
import { BaseButton, BaseCheckbox, BaseInput } from "@/components/core"
...
export const EditSubInitiative: FC<EditSubInitiativeProps> = ({ isOpen, close }) => {
    return (
                                ...
                                <div className="flex flex-col w-full gap-5">
                                    ...
                                    <div className="grid gap-4">
                                        ...
                                        <div className="flex items-center gap-14">
                                            ...
                                            <BaseCheckbox label={<span className="font-medium text-grey-40 text-sm">Department-Section</span>} />
                                        </div>
