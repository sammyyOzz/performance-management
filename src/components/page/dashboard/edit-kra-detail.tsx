                                ...
                                <div className="grid w-full gap-8">
                                    ...
                                    <AnimatePresence mode="popLayout" initial={false}>
                                    {
                                        values.responsibilities.map((responsibility, index) =>
                                            <motion.div key={responsibility?.department_id} layout initial={{ y: -5, opacity: 0 }} animate={{ y: 0, opacity: 1 }} exit={{ y: -5, opacity: 0 }} transition={{ type: "spring", bounce: 0 }} className="flex gap-4">
