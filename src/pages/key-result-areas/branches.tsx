...
export const BranchesKRAPage = () => {
    ...
    const columns = [
        ...
        },
        {
            ...
            cell: () => {
                return (
                    <span className="line-clamp-2">SW&T</span>
                )
            }
        },
        {
    ...
    return (
        <section className="flex flex-1 py-6 px-5 md:px-8 lg:px-10 page-height overflow-y-scroll">
            <div className="flex flex-col flex-1 gap-6 max-w-screen-2xl mx-auto">
                <div className="flex flex-col gap-3">
                    <div className="grid gap-1 py-2 border-b border-b-[#DFE2E7]">
                        <h1 className="font-semibold text-2xl text-black">HUMAN RESOURCES MANAGEMENT - BRANCHES</h1>
            ...
            <EditBranchKra isOpen={toggleModals.openEditKra} close={() => toggleEditKra()} />
        </section>
    )
}