...
export const DivisionKRAPage = () => {
    ...
    return (
        <section className="flex flex-1 py-6 px-5 md:px-8 lg:px-10 page-height overflow-y-scroll">
            <div className="flex flex-col flex-1 gap-6 max-w-screen-2xl mx-auto">
                <div className="flex flex-col gap-3">
                    <div className="grid gap-1 py-2 border-b border-b-[#DFE2E7]">
                        <h1 className="font-semibold text-2xl text-black">HUMAN RESOURCES MANAGEMENT - DIVISION</h1>
                    ...
                    <div className="flex flex-col gap-1 w-full">
                        ...
                        <div className="flex items-center gap-8 p-4 rounded-md border border-[#DFE2E7]">
                            <span className="text-sm text-grey-40">SW & T</span>
                            <span className="text-sm text-grey-40">ADP</span>
            ...
            <EditDivisionKra isOpen={toggleModals.openEditKra} close={() => toggleEditKra()} />
        </section>
    )
}